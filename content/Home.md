...
This repository comes with a **[template](https://github.com/SnekOfSpice/dialog-editor/wiki/Using-the-visual-novel-template)** you can use to **create a visual novel without code.**
...
Use the [[_Sidebar|Sidebar]] to get started and get the plugin [here](https://github.com/SnekOfSpice/dialog-editor/wiki/Get-the-plugin) :3
